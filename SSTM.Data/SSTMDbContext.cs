...
namespace SSTM.Data
{
    public class SSTMDbContext : DbContext, IDbContext
    {
        public SSTMDbContext() : base("name=SSTMDbContext")
        {
            Database.SetInitializer<SSTMDbContext>(null);
        ...
        {
            modelBuilder.HasDefaultSchema("sstmo");
        ...
        public int BackupDatabase(string sql, string destinationPath)
        {
            return Database.ExecuteSqlCommand(TransactionalBehavior.DoNotEnsureTransaction, sql, destinationPath);
        }
    }
}