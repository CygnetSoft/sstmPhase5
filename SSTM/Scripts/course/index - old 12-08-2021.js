...
function backButtonClick() {
    ...
    //    window.location.href = localStorage.getItem("url2");
    //}
    //if (localStorage.getItem("SubfolderCount") == 2) {
    //    localStorage.setItem("SubfolderCount", localStorage.getItem("SubfolderCount") - 1);
    //    window.location.href = localStorage.getItem("url1");
    //}
...
function InittblCourses() {
    ...
    if (userRole === "Administration") {
        var aoColumns = [null, { "bVisible": false }, { "bVisible": false }, { "bVisible": false },
    ...
    if (userRole === "Director") {
        if (CourseType != "staff") {
            if ($('#ddlCourseStatus').find("option:selected").text() == "Pending")
                ...
                $('#ddlCourseStatus').find("option:selected").text() == "Under Improvement")
                aoColumns = [null, { "bVisible": false }, null, null,
                    localStorage.getItem("SubfolderCount") == 3 ? { "bVisible": false } : { "bSortable": false },
        ...
        if (($('#ddlCourseStatus').find("option:selected").text() === "Pending"))
            aoColumns = [null, { "bVisible": false }, { "bVisible": false }, { "bVisible": false },
                localStorage.getItem("SubfolderCount") == 3 ? { "bVisible": false } : { "bSortable": false },
        ...
        aoColumns = [null, { "bVisible": false }, { "bVisible": false }, { "bSortable": false },
            localStorage.getItem("SubfolderCount") == 3 ? { "bVisible": false } : { "bSortable": false },
            { "bSortable": false }, { "bVisible": false }, { "bVisible": false }, { "bVisible": false },
            { "bVisible": false }, { "bVisible": false }, { "bVisible": false }, { "bVisible": false },
            { "bVisible": false }, { "bVisible": false }];
    ...
    else
    {
        if (userRole === "Administration") 
        {
            var aoColumns = [null, { "bVisible": false }, { "bVisible": false }, { "bVisible": false },
                        ...
                        { "bVisible": false }, { "bVisible": false }, { "bVisible": false }, { "bVisible": true },
                        { "bVisible": true }, { "bVisible": false }, { "bVisible": false }];
            $('#divFilterByDocStatus').hide();
        }
        if (userRole === "Director") {
            if (CourseType != "staff") {
